...
$\rho{\approx}1.8$. How learned policies can acquire and retain such
commitment---and carry it across the contention range in a single policy---is
the subject of companion work; code for those experiments is included in the
repository. (v) Our games
