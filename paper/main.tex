...
size per se. First, re-parameterizing the tokens to be $N$-invariant in scale
...
$N{=}48$ at $c{=}0.9$, flat or improving at every $c$. What degrades with $N$ is
...
Breaking the $1/N$ scaling is partially possible: adding a count-preserving
